...
import com.cw.tv_yt.model.Playlist;
import com.cw.tv_yt.model.Video;
import com.cw.tv_yt.model.VideoCursorMapper;
import com.cw.tv_yt.player.VideoPlayerGlue;
...
//        args.putString(VideoContract.CategoryEntry.COLUMN_CATEGORY_NAME, mVideo.category);
        args.putString(VideoContract.CategoryEntry.COLUMN_CATEGORY_NAME, "temp");
        getLoaderManager()
