...
import com.cw.tv_yt.data.VideoDbBuilder;
import com.cw.tv_yt.data.VideoDbHelper;
...
public class VideoDbIntegrationTest {
    ...
    public void resetAndInsertOnlineVideos() throws JSONException, IOException {
        ...
        List<ContentValues> contentValuesList =
                videoDbBuilder.fetch(mContext.getResources().getString(R.string.catalog_url_1));
